      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[90%] max-w-sm rounded-2xl bg-white dark:bg-brand-800 p-5 sm:p-6 shadow-2xl border border-brand-100 dark:border-white/10 text-center"
          >
